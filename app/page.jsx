...
export const metadata = {
  title: 'MathsMine3 — Timed math. Fictional mining. Wallet identity. Terminal economy. Real-time 3D multiplayer world. | Free Browser Game',
  ...
  openGraph: {
    ...
    images: [{ url: '/og-image.jpg', width: 1200, height: 630, alt: 'MathsMine3 — Timed math. Fictional mining. Wallet identity. Terminal economy. Real-time 3D multiplayer world.' }],
  },
};
