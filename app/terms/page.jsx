...
export default function TermsPage() {
  return (
    <main className="w-full max-w-2xl mx-auto px-4 py-6 font-mono text-sm text-gray-300">
      ...
      <p className="text-[0.65rem] text-slate-600 mb-6">Last updated: April 2026 · MathsMine3 / FreakingAI · <a href="mailto:botsandpods@gmail.com" className="text-cyan-700 hover:text-cyan-400">botsandpods@gmail.com</a></p>
