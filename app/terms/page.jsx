  ...
  return (
    <main className="w-full max-w-2xl mx-auto px-4 py-6 font-mono text-sm text-gray-300">
      ...
      <section className="mb-6">
        ...
        <ul className="list-none mt-2 space-y-1 text-[1.00rem] leading-relaxed text-gray-400">
          <li>
      ...
      <section className="mb-6">
        ...
        <p className="text-[1.00rem] leading-relaxed text-gray-400">
          {es
            ? <>Las donaciones voluntarias en ETH enviadas a través del portal son <strong className="text-gray-300">irrembolsables</strong>. Las transacciones blockchain son irreversibles. Las donaciones no otorgan acceso exclusivo, funciones ni derechos adicionales. Apoyan el desarrollo de la plataforma.</>
