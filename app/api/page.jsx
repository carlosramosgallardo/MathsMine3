...
export default function ApiPage() {
    ...
    <main className="w-full px-2 py-1" style={{ '--mm3-accent': frameAccent }}>
      <SectionFrame accent={frameAccent} id="api-section">
        <div className="max-w-2xl mx-auto px-1 py-1 text-sm font-mono text-gray-400">
          ...
          {/* /api/token-value */}
          <h2 className="text-xl font-semibold mt-8 mb-2 text-white">{copy.tokenValue}</h2>
  ...
  "updatedAt": "2025-03-23T20:00:00Z"
          ...
          {/* /api/token-history */}
          <h2 className="text-xl font-semibold mt-8 mb-2 text-white">{copy.tokenHistory}</h2>
          ...
          <pre className="bg-gray-900 p-3 rounded overflow-auto mb-6">{`[
  {
    ...
    "market_delta": -0.000025
          ...
          <h2 className="text-xl font-semibold mt-8 mb-2 text-white">{copy.tokenHistoryMinutes}</h2>
          ...
          <pre className="bg-gray-900 p-3 rounded overflow-auto mb-6">{`[
  {
    ...
    "market_delta": 0
          ...
          {/* /api/nft-events */}
          <h2 className="text-xl font-semibold mt-8 mb-2 text-white">{copy.nftEvents}</h2>
  ...
  },
  {
    ...
    "emoji": "❤️"
          ...
          {/* /api/leaderboard */}
          <h2 className="text-xl font-semibold mt-8 mb-2 text-white">{copy.leaderboard}</h2>
  ...
  "items": [
    {
      ...
      "nftmojis": ["🔮", "🍀"]
          ...
          {/* /api/status */}
          <h2 className="text-xl font-semibold mt-8 mb-2 text-white">{copy.status}</h2>
  ...
  "timestamp": "2026-04-21T06:55:34.476Z"
          ...
          {/* Rate limiting note */}
          <h2 className="text-xl font-semibold mt-8 mb-2 text-white">{copy.rateLimit}</h2>
