    ...
    <main className="w-full px-2 py-1" style={{ '--mm3-accent': frameAccent }}>
      <SectionFrame accent={frameAccent} id="manifesto-section">
        ...
        <section className="mb-6">
          ...
          <p className="leading-relaxed mt-3">
            {language === 'es'
              ? 'El relay convierte el portal en un espacio compartido sin convertirlo en un vertedero de datos. Mining, trading, ranking, comprar/revender NFTmojis, lanzar comandos y hablar ocurren dentro de la misma cultura terminal. La presencia de wallet es también presencia social. El contador del lateral muestra wallets/total para distinguir los logados de los conectados en cualquier apartado del portal.'
              : 'The relay turns the portal into a shared space without turning it into a data dump. Mining, trading, ranking, buying/reselling NFTmojis, launching commands, and talking all happen inside the same terminal culture. Wallet presence is social presence. The sidebar counter shows wallets/total to distinguish logged-in users from all connected across any section of the portal.'}
          </p>
        </section>
