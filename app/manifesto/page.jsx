    ...
    <main className="flex flex-col items-center w-full px-4 pt-10 pb-20 text-sm font-mono text-gray-400 bg-black overflow-x-hidden">
      <div className="max-w-2xl w-full break-words overflow-x-hidden">
        ...
        <section className="mb-6">
          ...
          <p className="leading-relaxed">
            Donations made through wallet interaction are entirely voluntary and non-refundable. They do not represent a purchase, investment, or financial product, and they do not grant access to any exclusive features or privileges within the platform.
          </p>
          <p className="leading-relaxed">
            The donation amount is fixed at a symbolic value of <strong>0.00001 ETH</strong> and serves solely to support the ongoing development and maintenance of the project.
          </p>
          <p className="leading-relaxed">
            In the future, if the community decides to attribute real value to the project, these donations may conceptually evolve into a foundation for a genuine <strong>MM3</strong> token — but only if this occurs through collective consensus and without any financial promise or guarantee.
          </p>
        </section>
        ...
        <section className="mb-6">
          <p className="leading-relaxed">
            The platform is completely transparent, providing a public <Link href="/api" className="text-blue-400 underline">API</Link> that lets you query, at any moment, real-time and historical data on the token’s value, wallet contributions, polls, voting results and donations.
          </p>
        </section>
