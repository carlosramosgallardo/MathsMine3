...
Optional permanent link: push a tag `v0.1.0-beta.13` (SemVer pre-release) — the workflow attaches the APK to a **GitHub Release** on the repo home.
...
Tags `v0.1.0-beta.N` → Release con el APK adjunto.
