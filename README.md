...
|---|---|---|---|
| [Male Body](https://sketchfab.com/3d-models/male-body-15a422001834483c9750ce6117d59cc1) | `public/models/man.runtime.glb` — default body for players, bots, bosses and statues | [Alexander Antipov](https://sketchfab.com/Dessen) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Fennec — Rocket League Car](https://sketchfab.com/3d-models/fennec-rocket-league-car-5b43b50b6eeb4a12a29671df3418f57a) | `public/models/rl-car.runtime.glb` — the drivable car | [Jako](https://sketchfab.com/fairlight51) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Benjamin Netanyahu Riding Donald Trump](https://sketchfab.com/3d-models/benjamin-netanyahu-riding-donald-trump-c48169c28d294588abb47c30dedbb06d) | `public/models/trump.runtime.glb` — the M5 boss, who crawls on all fours | [Rudy](https://sketchfab.com/Rudy27) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Vladimir Putin](https://sketchfab.com/3d-models/vladimir-putin-a2429851872e4f2a8f93f0eb3b4d41a2) | `public/models/putin.runtime.glb` — the M3 boss | [ItsKrish7](https://sketchfab.com/ItsKrish7) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Ledger Nano S](https://sketchfab.com/3d-models/ledger-nano-s-48460b4b82724e9b8d03c0c3574793a5) | `public/models/tool-usb.runtime.glb` — the held mining tool | [rtql8d](https://sketchfab.com/rtql8d) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Javier Milei MOTOSIERRA 2023](https://sketchfab.com/3d-models/javier-milei-motosierra-2023-f95bc1d58e2e4c82804f77b11afd71ff) | `assets/model-sources/milei.glb` / `milei-figure.glb` — the M1 Milei statue (chainsaw; figure stands on the shared column base) | [FrancoGUG](https://sketchfab.com/Franco.GUG) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Volodymyr Oleksandrovych Z.](https://sketchfab.com/3d-models/volodymyr-oleksandrovych-z-4eaf7d718b064913b4021da19656886e) | `public/models/zelenski.runtime.glb` — the M1 Zelensky statue (original bind pose; stadium-cheer arm idle) | [jamray747](https://sketchfab.com/jamray747) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Kim Jong-Un - statue North Korea DPRK](https://sketchfab.com/3d-models/kim-jong-un-statue-north-korea-dprk-1da77051ecd0443e80c862c54eafaea0) | `public/models/kim.runtime.glb` — the M4 boss | [Brian Trepanier](https://sketchfab.com/CMBC) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Male Head](https://sketchfab.com/3d-models/male-head-0247a25a04ba46b99629130277fe39b7) | Retired cockpit head (no longer distributed) | [Alexander Antipov](https://sketchfab.com/Dessen) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Emmanuel Macron Avatar](https://sketchfab.com/3d-models/emmanuel-macron-avatar-a856203f463c43c592fffbf4c8bfc71b) | `public/models/macron.runtime.glb` — the M2 Macron statue (original bind pose; diplomatic-wave arm idle) | [Jasnoor Singh](https://sketchfab.com/jasnoorsingh) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
...
| [Nuclear Reactor Bomb Chamber](https://sketchfab.com/3d-models/nuclear-reactor-bomb-chamber-6b2031b189e64936a8abd16231c061b8) | `public/models/nuclear.runtime.glb` — the nuke cube on every map | [NinjaJD](https://sketchfab.com/NinjaJD) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
...
| NFTJI de Mining | Compra o reventa en el mundo 3D de Mining | Desbloquea comando de Relaying diario |
...
| **Kim Jong-un** | M4 | 3500 | 16 | 24 (13% prob.) | 700 MM3 + 700 € |
...
El mundo 3D de Mining muestra **MM3 BLOCK CHAIN IN PROGRESS** con un porcentaje:
...
La ayuda de Relaying (`/?`) incluye `/mine block #029` como forma corta para minar bloques libres de cadena del mundo 3D, y `/exec @wallet` para ejecuciones de relay.
...
El resto de datos visibles — nivel, balance MM3, actividad de Trade, propiedad de NFTJIs, presencia en el mundo 3D, penalizaciones activas — muestra el contexto detrás de los porcentajes de minado.
...
| Bloque de cadena minado | Avanza la carrera compartida de 1000 celdas; el mensaje de Relaying del bot muestra `chain:X.XX%` |
...
| `/api/mining-snapshot` | Estado de bloques del mundo 3D |
| `/api/mine-block` | Mina un bloque libre de cadena del mundo 3D desde el flujo de comando de Relaying |
...
MathsMine3 es una app **Next.js** desplegada en **Vercel**. Un push a `main` dispara el deploy de producción automáticamente.

- Variables de entorno: ver [Ejecución Local](#ejecucion-local) (configúralas en el proyecto de Vercel).
- `vercel.json` — cron semanal del security scan.
...
Los personajes y vehículos son modelos de terceros descargados de Sketchfab bajo **[CC BY 4.0](http://creativecommons.org/licenses/by/4.0/)**. Gracias a sus autores: sin ellos el juego no tendría este aspecto.

| Modelo | En el juego | Autor | Licencia |
|---|---|---|---|
| [Male Body](https://sketchfab.com/3d-models/male-body-15a422001834483c9750ce6117d59cc1) | `public/models/man.runtime.glb` — cuerpo por defecto de jugadores, bots, bosses y estatuas | [Alexander Antipov](https://sketchfab.com/Dessen) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Fennec — Rocket League Car](https://sketchfab.com/3d-models/fennec-rocket-league-car-5b43b50b6eeb4a12a29671df3418f57a) | `public/models/rl-car.runtime.glb` — el coche conducible | [Jako](https://sketchfab.com/fairlight51) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Benjamin Netanyahu Riding Donald Trump](https://sketchfab.com/3d-models/benjamin-netanyahu-riding-donald-trump-c48169c28d294588abb47c30dedbb06d) | `public/models/trump.runtime.glb` — el boss de M5, que se mueve a cuatro patas | [Rudy](https://sketchfab.com/Rudy27) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Vladimir Putin](https://sketchfab.com/3d-models/vladimir-putin-a2429851872e4f2a8f93f0eb3b4d41a2) | `public/models/putin.runtime.glb` — el boss de M3 | [ItsKrish7](https://sketchfab.com/ItsKrish7) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Ledger Nano S](https://sketchfab.com/3d-models/ledger-nano-s-48460b4b82724e9b8d03c0c3574793a5) | `public/models/tool-usb.runtime.glb` — la herramienta de minado | [rtql8d](https://sketchfab.com/rtql8d) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Javier Milei MOTOSIERRA 2023](https://sketchfab.com/3d-models/javier-milei-motosierra-2023-f95bc1d58e2e4c82804f77b11afd71ff) | `assets/model-sources/milei.glb` / `milei-figure.glb` — la estatua de Milei en M1 (motosierra; la figura va sobre la basa compartida) | [FrancoGUG](https://sketchfab.com/Franco.GUG) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Volodymyr Oleksandrovych Z.](https://sketchfab.com/3d-models/volodymyr-oleksandrovych-z-4eaf7d718b064913b4021da19656886e) | `public/models/zelenski.runtime.glb` — la estatua de Zelenski en M1 (pose original; idle de brazos tipo ovación) | [jamray747](https://sketchfab.com/jamray747) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Kim Jong-Un - statue North Korea DPRK](https://sketchfab.com/3d-models/kim-jong-un-statue-north-korea-dprk-1da77051ecd0443e80c862c54eafaea0) | `public/models/kim.runtime.glb` — el boss de M4 | [Brian Trepanier](https://sketchfab.com/CMBC) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Male Head](https://sketchfab.com/3d-models/male-head-0247a25a04ba46b99629130277fe39b7) | Cabeza anterior del RL-car (ya no se distribuye) | [Alexander Antipov](https://sketchfab.com/Dessen) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Emmanuel Macron Avatar](https://sketchfab.com/3d-models/emmanuel-macron-avatar-a856203f463c43c592fffbf4c8bfc71b) | `public/models/macron.runtime.glb` — la estatua de Macron en M2 (pose original; idle de saludo diplomático) | [Jasnoor Singh](https://sketchfab.com/jasnoorsingh) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [DnD Tokens](https://sketchfab.com/3d-models/dnd-tokens-cc40d30e125e4006aa53e53a0e78ee0b) | `public/models/pedestal.glb` — pedestal ligero con marca MM3 para Milei, Zelenski y Macron | [Birdy.82](https://sketchfab.com/Birdy.82) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
| [Nuclear Reactor Bomb Chamber](https://sketchfab.com/3d-models/nuclear-reactor-bomb-chamber-6b2031b189e64936a8abd16231c061b8) | `public/models/nuclear.runtime.glb` — el cubo nuclear en cada mapa | [NinjaJD](https://sketchfab.com/NinjaJD) | [CC BY 4.0](http://creativecommons.org/licenses/by/4.0/) |
