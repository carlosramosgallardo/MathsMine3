...
function poseZelenskyCheer(bones, t) {
  ...
  setBoneXYZ(bones.LeftUpperArm, -0.92 + pump * 0.28, flap * 0.08, -0.32)
  setBoneXYZ(bones.RightUpperArm, -0.92 + pump * 0.28, -flap * 0.08, 0.32)
  setBoneXYZ(bones.LeftLowerArm, 0.12, 0.62 + pump * 0.14, 0)
  setBoneXYZ(bones.RightLowerArm, 0.12, -0.62 - pump * 0.14, 0)
  setBoneXYZ(bones.LeftHand, 0, 0, flap * 0.22)
  setBoneXYZ(bones.RightHand, 0, 0, -flap * 0.22)
}
...
function poseMacronWave(bones, t) {
  ...
  setBoneXYZ(bones.LeftUpperArm, Math.PI * 0.5 + nod, 0.12, -0.62)
  setBoneXYZ(bones.LeftLowerArm, 0.08, 1.05, 0.18)
  setBoneXYZ(bones.LeftHand, 0.1, 0, 0.25)
  setBoneXYZ(bones.RightUpperArm, -0.18 + nod, 0.22, 0.88)
  setBoneXYZ(bones.RightLowerArm, 0.05, -1.18, flap * 0.72)
  setBoneXYZ(bones.RightHand, 0, flap * 0.18, flap * 0.4)
}
