...
/** Hide limbs/tools and drop the skull (+ torso) into a cockpit. Head and
 *  shoulders stay visible on top of the car; legs stay tucked in the cabin. */
export function seatHumanoidGlbInCar(parent, { neckY = 0.48, neckZ = 0 } = {}) {
  ...
  // Keep the skinned torso/skull — riders should read as head+shoulders in the cabin.
  if (bodyMesh) bodyMesh.visible = true
  if (body) body.visible = true
  if (parent.userData.humanoidGlbHeadMesh) parent.userData.humanoidGlbHeadMesh.visible = true
