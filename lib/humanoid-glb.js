...
/**
 * Cockpit peek: parent-space Y of the neck while seated. Higher than the old
 * chin-on-roof value (0.52) so the shoulders sit above the cabin, same XZ.
 */
export const HUMANOID_GLB_CAR_NECK_Y = 0.68
