...
test('car mount neck peek puts shoulders above the old chin-on-roof line', () => {
  ...
  assert.ok(seatedShoulderY > 0.52, 'shoulders sit above the previous neck peek')
  assert.ok(seatedShoulderY < 0.72, 'shoulders stay in the cabin, not standing on the roof')
})
