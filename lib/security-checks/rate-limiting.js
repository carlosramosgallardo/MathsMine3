...
const TARGETS = [
  ...
  },
  {
    ...
    body: '{}',
    label: 'PvP hit',
    rationale: 'Hit application has no rate limiting — bots can spam hits far faster than in-game physics allow, enabling machine-speed kill farming.',
    attacks: 'Automated hit spam, sub-second kill sequences, attack NFTJI farming via rapid critical hits',
  },
  {
    path: '/api/stormroll-damage',
    method: 'POST',
    body: '{}',
    label: 'StormRoll damage',
    rationale: 'Damage endpoint called during 15-min dice windows — without rate limiting a script can simultaneously damage all active wallets in the window.',
    attacks: 'Automated mass-kill during StormRoll window, simultaneous HP drain on all active players',
  },
]
