...
export const CHECKS = [
  ...
  { id: 'wallet_auth',      weight: 15, run: url   => runWalletAuthCheck(url)       },
  { id: 'cookie_security',  weight:  5, run: url   => runCookieSecurityCheck(url)   },

  // ── Injection & Input Security ─────────────────────────────────────────────
  { id: 'injection_scan',   weight: 22, run: url   => runInjectionScanCheck(url)    },
  ...
  { id: 'rate_limiting',    weight:  8, run: url   => runRateLimitingCheck(url)     },
]
