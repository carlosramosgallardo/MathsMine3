...
export const CHECKS = [
  { id: 'npm_vulns',        weight: 12, run: ()  => runNpmVulnsCheck()          },
  { id: 'security_headers', weight: 18, run: url => runHeadersCheck(url)        },
  { id: 'api_auth',         weight: 20, run: url => runApiAuthCheck(url)        },
  { id: 'sensitive_paths',  weight: 15, run: url => runSensitivePathsCheck(url) },
  { id: 'cors_policy',      weight: 10, run: url => runCorsPolicyCheck(url)     },
  { id: 'http_methods',     weight: 5,  run: url => runHttpMethodsCheck(url)    },
  { id: 'wallet_auth',      weight: 20, run: url => runWalletAuthCheck(url)     },
]
