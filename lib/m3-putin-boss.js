import { PEACH_CASTLE_ARENA } from './mining-map-ambient'
...
/** Grid centre of Former Soviet Union (M3). */
export const M3_PUTIN_BOSS_SPAWN = Object.freeze({
  row: Math.round(PEACH_CASTLE_ARENA.row),
  col: Math.round(PEACH_CASTLE_ARENA.col),
  gx: PEACH_CASTLE_ARENA.col + 0.5,
  gy: PEACH_CASTLE_ARENA.row + 0.5,
})
