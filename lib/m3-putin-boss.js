...
export const M3_PUTIN_BOSS_LOW_DAMAGE = 12
export const M3_PUTIN_BOSS_MEDIUM_DAMAGE = 18
export const M3_PUTIN_BOSS_HIGH_DAMAGE = 26
export const M3_PUTIN_BOSS_ATTACKS = Object.freeze([
  Object.freeze({ id: 'jab', tier: 'low', damage: M3_PUTIN_BOSS_LOW_DAMAGE, durationMs: 780, weight: 50 }),
  Object.freeze({ id: 'sweeping-hook', tier: 'medium', damage: M3_PUTIN_BOSS_MEDIUM_DAMAGE, durationMs: 920, weight: 32 }),
  Object.freeze({ id: 'spinning-kick', tier: 'high', damage: M3_PUTIN_BOSS_HIGH_DAMAGE, durationMs: 1120, weight: 18 }),
])
...
/** M3 boss stand position — gx=col, gy=row (in-game readout shows row, col). */
...
export const M3_PUTIN_BOSS_IDLE_FACING = bossGatewayIdleFacing('3', M3_PUTIN_BOSS_SPAWN)

export const M3_PUTIN_BOSS_SCALE = 1.85
/** Textured body: Vladimir Putin (Sketchfab, CC BY 4.0). */
export const M3_PUTIN_BOSS_MODEL_URL = '/models/putin.glb'
export const M3_PUTIN_HEAD_TEXTURE_URL = '/images/m3-putin-head.webp'
/** Alpha-cutout face (from putin-head.glb's embedded image) — mask silhouette follows the head outline. */
export const M3_PUTIN_MASK_TEXTURE_URL = '/images/m3-putin-mask.webp'
