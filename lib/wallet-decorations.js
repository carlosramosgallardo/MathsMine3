...
// Names and descriptions for each NFTmoji — used as tooltips throughout the portal
export const WALLET_DECORATION_LABELS = {
  ...
  [WALLET_DECORATIONS.marketGenesis]: {
    name: 'Genesis Uplink',
    title: 'Genesis Uplink — Market nftmoji claimed · uplink synced to this wallet',
  },
};
...
export const MARKET_EVENT_TYPE_NFTMOJI = 'nftmoji_claim';
