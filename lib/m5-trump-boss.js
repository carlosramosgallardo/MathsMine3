...
export const M5_TRUMP_BOSS_LOW_DAMAGE = 20
export const M5_TRUMP_BOSS_MEDIUM_DAMAGE = 30
export const M5_TRUMP_BOSS_HIGH_DAMAGE = 42
export const M5_TRUMP_BOSS_ATTACKS = Object.freeze([
  Object.freeze({ id: 'front-pounce', tier: 'low', damage: M5_TRUMP_BOSS_LOW_DAMAGE, durationMs: 520, weight: 50 }),
  Object.freeze({ id: 'side-swipe', tier: 'medium', damage: M5_TRUMP_BOSS_MEDIUM_DAMAGE, durationMs: 820, weight: 32 }),
  Object.freeze({ id: 'bull-rush', tier: 'high', damage: M5_TRUMP_BOSS_HIGH_DAMAGE, durationMs: 1080, weight: 18 }),
])
...
// Scale 2 on the shared humanoid (crown 1.075) is the Trump height anchor.
export const M5_TRUMP_BOSS_SCALE = 2
/** Sculpt body: Trump on all fours, baked by scripts/bake-sculpt-glb.mjs. */
export const M5_TRUMP_BOSS_MODEL_URL = '/models/trump.glb'
/**
 * Hit box of the crawling sculpt in body-local units (crown 1.075 like every
 * other character, so scale 2 still matches the lineup). The silhouette is low
 * and long instead of tall: `backY` is the ride height of the spine, and the
 * head zone is the top of the sculpt.
 */
export const M5_TRUMP_BOSS_BOUNDS = Object.freeze({
  headTop: 1.075,
  headBottom: 0.86,
  backY: 0.62,
  feet: 0.04,
