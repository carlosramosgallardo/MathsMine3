...
export function syncCapsuleLocomotion(bodyPivot, runtime, {
  ...
  // Skinned scans bend their own limbs. Rigid limb shells parented to capsules
  // already swing — skip whole-mesh rock/hop so the suit stays planted.
  const lean = !bodyPivot.userData?.humanoidGlbBones && !bodyPivot.userData?.bipedLimbsMounted
  if (moved > 0.0008) {
