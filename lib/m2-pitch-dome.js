...
import { setRlCarBoostLit } from './rl-car-boost'
...
export function updateM2PitchDomeRuntime(runtime, dt, players = null) {
  ...
  for (const bot of bots) {
    ...
    // Painted boost lights while boosting or during the ball-strike hop.
    setRlCarBoostLit(bot.car, runtime.time < (bot.boostUntil || 0) || runtime.time < (bot.jumpUntil || 0))
  }
