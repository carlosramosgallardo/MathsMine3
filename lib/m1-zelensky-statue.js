...
import { PLAZA_ARM_IDLE } from './humanoid-glb'

export const M1_ZELENSKY_STATUE_ID = 'm1_zelensky_statue'
/** Textured Ready-Player-style body on the shared Roman column base. */
export const M1_ZELENSKY_STATUE_SCALE = STATUE_PLAZA_GROUP_SCALE
...
/** Textured Zelensky prop — Roman column base; home stays rooted, mining patrols. */
export function createM1ZelenskyStatueVisual(THREE, lowDetail = false, { retro = false } = {}) {
...
export function flashM1ZelenskyStatue() {}
