 ...
 * The baked GLB already carries Sketchfab's Z-up → Y-up node matrix — do not
 * pitch it again at runtime or the torus lies flat and disappears.
 */
export const STATUE_PLINTH_HEIGHT = 0.36
