...
export const STATUE_PLINTH_SRC_YMAX = 0.155
...
/**
 * Milei-style beige pedestal for Macron/Zelensky/Milei-figure/etc. The shared
 * extract is the only plaza base — figure GLBs must not keep a baked pedestal.
 */
