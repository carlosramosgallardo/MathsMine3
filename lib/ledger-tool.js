 ...
 * and forward. Hits are an overhead baton smash, not a limp wrist flick.
 */
 ...
 * forward/out, matching a sword grip at the hip ready for a strike.
 */
export const LEDGER_HOLD_ANGLE = -0.38
...
/** Right-arm hold: forward like a sword guard, not parade rest. */
...
export function poseLedgerSwing(tool, {
  ...
  tool.rotation.x = -raise * LEDGER_SWING.pitch + cut * LEDGER_SWING.cutPitch
  tool.rotation.y = cut * LEDGER_SWING.yaw - raise * 0.18
  tool.rotation.z = raise * LEDGER_SWING.roll - cut * LEDGER_SWING.cutYaw
}
