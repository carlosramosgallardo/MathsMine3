...
/**
 * Fixed plaza statue: textured multi-mesh GLB on the floor (no plinth).
 * Used by Zelensky (M1) and Macron (M2). Home rail walks them like bosses.
 */
export function createFixedTexturedStatueVisual(THREE, {
  ...
  // Walkable on the home rail — not a frozen salute prop.
