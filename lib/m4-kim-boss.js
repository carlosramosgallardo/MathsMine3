...
export const M4_KIM_BOSS_LOW_DAMAGE = 16
export const M4_KIM_BOSS_MEDIUM_DAMAGE = 24
export const M4_KIM_BOSS_HIGH_DAMAGE = 34
export const M4_KIM_BOSS_ATTACKS = Object.freeze([
  Object.freeze({ id: 'overhead-chop', tier: 'low', damage: M4_KIM_BOSS_LOW_DAMAGE, durationMs: 780, weight: 50 }),
  Object.freeze({ id: 'shoulder-barge', tier: 'medium', damage: M4_KIM_BOSS_MEDIUM_DAMAGE, durationMs: 940, weight: 32 }),
  Object.freeze({ id: 'quake-stomp', tier: 'high', damage: M4_KIM_BOSS_HIGH_DAMAGE, durationMs: 1160, weight: 18 }),
])
...
// 171 cm on the Trump anchor (scale 2 ≡ 190 cm, same 1.36 local height).
export const M4_KIM_BOSS_SCALE = 1.8
/** Textured statue body: Kim Jong-Un (Sketchfab, CC BY 4.0). */
export const M4_KIM_BOSS_MODEL_URL = '/models/kim.glb'
export const M4_KIM_HEAD_TEXTURE_URL = '/images/m4-kim-head.webp'
/** Legacy alpha-cutout face — unused once the textured chibi GLB ships. */
