...
export function getMiningMapEdgeState(mapId) {
  ...
  return {
    north: adj.north
      ? { open: true, targetMapId: adj.north, bands: colBands, fullEdge }
      : { open: false },
    south: adj.south
      ? { open: true, targetMapId: adj.south, bands: colBands, fullEdge }
      : { open: false },
    east: adj.east
      ? { open: true, targetMapId: adj.east, bands: rowBands, fullEdge }
      : { open: false },
    west: adj.west
      ? { open: true, targetMapId: adj.west, bands: rowBands, fullEdge }
      : { open: false },
  }
}
