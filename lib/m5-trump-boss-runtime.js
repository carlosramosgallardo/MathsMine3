...
export function createM5TrumpBossVisual(THREE, lowDetail = false) {
  ...
  addBox(bodyPivot, 0.20, 0.32, 0.02, shirtMat, 0, 0.54, 0.05)
  ...
  attachBossHeadPhoto(THREE, bodyPivot, M5_TRUMP_HEAD_TEXTURE_URL, lowDetail, {
  ...
  group.userData.headY = 1.12 * M5_TRUMP_BOSS_SCALE
...
export function updateM5TrumpBoss({
  ...
  if (!fighting) {
    ...
    runtime.targetWallet = null
    runtime.facing = M5_TRUMP_BOSS_IDLE_FACING + Math.sin(runtime.idlePhase * 0.5) * 0.12
    return runtime
  }
