...
export function createM4KimBossVisual(THREE, lowDetail = false) {
  ...
  addBox(bodyPivot, 0.08, 0.22, 0.18, hairMat, -0.19, 1.04, 0.04)
  addBox(bodyPivot, 0.08, 0.22, 0.18, hairMat, 0.19, 1.04, 0.04)
  addBox(bodyPivot, 0.30, 0.12, 0.26, hairMat, 0, 1.28, 0.08)
  addBox(bodyPivot, 0.22, 0.08, 0.22, hairMat, 0, 1.38, 0.10)
