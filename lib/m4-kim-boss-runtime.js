...
export function createM4KimBossVisual(THREE, lowDetail = false) {
  ...
  const hairMat = mat('#111827', 0.42, 0.08)
  ...
  // Mao jacket — boxy torso, high collar
  addBox(bodyPivot, 0.54, 0.50, 0.30, suitGrey, 0, 0.56, 0)
  addBox(bodyPivot, 0.56, 0.10, 0.28, suitDark, 0, 0.86, 0)
  addBox(bodyPivot, 0.08, 0.14, 0.02, suitDark, -0.14, 0.80, -0.148)
  addBox(bodyPivot, 0.08, 0.14, 0.02, suitDark, 0.14, 0.80, -0.148)
  // Juche star badge
  ...
  addBox(bodyPivot, 0.06, 0.04, 0.02, skinBright, -0.10, 0.98, -0.148)
  addBox(bodyPivot, 0.06, 0.04, 0.02, skinBright, 0.10, 0.98, -0.148)
  addBox(bodyPivot, 0.04, 0.025, 0.01, basic('#1a1208'), -0.09, 1.06, -0.148)
  addBox(bodyPivot, 0.04, 0.025, 0.01, basic('#1a1208'), 0.09, 1.06, -0.148)
  addBox(bodyPivot, 0.08, 0.02, 0.01, mat('#c48878', 0.6, 0), 0, 0.92, -0.149)

  // Iconic haircut — shaved sides, voluminous top
  addBox(bodyPivot, 0.08, 0.20, 0.22, skinMat, -0.20, 1.04, 0.02)
  addBox(bodyPivot, 0.08, 0.20, 0.22, skinMat, 0.20, 1.04, 0.02)
  addBox(bodyPivot, 0.34, 0.22, 0.32, hairMat, 0, 1.20, 0.06)
  addBox(bodyPivot, 0.28, 0.14, 0.28, hairMat, 0, 1.34, 0.10)
  addBox(bodyPivot, 0.20, 0.08, 0.24, hairMat, 0, 1.42, 0.08)
