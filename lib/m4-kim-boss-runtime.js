...
export function createM4KimBossVisual(THREE, lowDetail = false) {
  ...
  // Mao jacket — torso and collar kept below/behind the portrait cube
  addBox(bodyPivot, 0.54, 0.44, 0.30, suitGrey, 0, 0.50, 0.02)
  addBox(bodyPivot, 0.56, 0.06, 0.28, suitDark, 0, 0.68, 0.06)
  addBox(bodyPivot, 0.08, 0.10, 0.02, suitDark, -0.14, 0.64, 0.06)
  addBox(bodyPivot, 0.08, 0.10, 0.02, suitDark, 0.14, 0.64, 0.06)
  // Juche star badge
  ...
  // Neck, head backing, and portrait cube
  addBox(bodyPivot, 0.12, 0.08, 0.10, skinMat, 0, 0.76, 0.04)
  addBox(bodyPivot, 0.32, 0.28, 0.18, skinMat, 0, 0.96, 0.04)
  ...
  group.userData.headY = 1.12 * M4_KIM_BOSS_SCALE
