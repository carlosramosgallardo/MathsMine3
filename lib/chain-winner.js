import { gridToBlockHex, MM3_BLOCK_CHAIN_REQUIREMENTS } from '@/lib/mm3-block-chain';
...
export async function checkAndAwardChainWinner(supabase) {
  const [{ data: allMinedRows }, { data: nftjiOwners }, { data: existingWinner }, { data: nftjiPositions, count: totalNftjiCells }] = await Promise.all([
