...
/** @deprecated Red eye glows removed — realistic avatars keep their own eyes. */
export const BOSS_EYE_FIGHT_COLOR = '#ff2020'

/** No-op: glowing fight eyes were retired. */
export function setBossMaskEyesRed() {}

/** No-op: glowing fight eyes were retired. */
export function attachBotEyeGlows() {
  return []
}
