export const MARKET_COMMANDS = [
  {
    ...
    payment: 'money',
    effect: 'money',
    command: '/drain [freakingAI@MM3] solve => (log10(100000)*(4000+x))+(12*(300+x))+((6000+3*x)/3) = ?',
  ...
  },
  {
    ...
    payment: 'money',
    effect: 'money',
    command: '/drain [freakingAI@MM3] solve => (7000+x)+(13*200)+(x*4) = ?',
  ...
  },
  {
    ...
    payment: 'money',
    effect: 'money',
    command: '/drain [freakingAI@MM3] solve => 9000+(8*x)+(3600/3) = ?',
  ...
  },
  {
    ...
    payment: 'money',
    effect: 'money',
    command: '/drain [freakingAI@MM3] solve => 11000+(21*x)+(1440/2) = ?',
  ...
  },
  {
    ...
    payment: 'money',
    effect: 'money',
    command: '/drain [freakingAI@MM3] solve => (12000+x*17)+(4096/4) = ?',
  ...
  },
  {
    ...
    payment: 'money',
    effect: 'money',
    command: '/drain [freakingAI@MM3] solve => 15000+(x*23)+(2048/2) = ?',
  ...
  },
  {
    ...
    payment: 'money',
    effect: 'money',
    command: '/drain [freakingAI@MM3] solve => 18000+(x*31)+(7777%1000) = ?',
  ...
  },
  {
    ...
    payment: 'money',
    effect: 'money',
    command: '/drain [freakingAI@MM3] solve => 22000+(x*37)+(9999/3) = ?',
  ...
  },
  {
    ...
    payment: 'money',
    effect: 'money',
    command: '/drain [freakingAI@MM3] solve => 26000+(x*41)+(12345%678) = ?',
  ...
  },
  {
    ...
    payment: 'money',
    effect: 'money',
    command: '/drain [freakingAI@MM3] solve => 30000+(x*47)+(8192/4) = ?',
