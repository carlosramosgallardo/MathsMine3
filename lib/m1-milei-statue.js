...
export function createM1MileiStatueVisual(THREE, lowDetail = false) {
  ...
  // Animation loops that reset bodyPivot.y must restore this base, not 0,
  // or Milei sinks back into the plinth.
  ...
  // Slightly oversized statue shoes — visible above the plinth rim.
