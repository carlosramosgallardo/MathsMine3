...
export function createM1MileiStatueVisual(THREE, lowDetail = false) {
  ...
  // Jacket & shirt — kept below the chin so the portrait cube stays unobstructed
  addBox(bodyPivot, 0.54, 0.44, 0.30, suit, 0, 0.50, 0.02)
  addBox(bodyPivot, 0.20, 0.12, 0.08, shirt, 0, 0.62, 0.06)
  ...
  // Neck + head backing for the photo cube
  addBox(bodyPivot, 0.10, 0.06, 0.10, skin, 0, 0.76, 0.04)
  addBox(bodyPivot, 0.28, 0.28, 0.18, skin, 0, 0.96, 0.04)
