...
export function spawnBossAttackBeam(existing, { fromGx, fromGy, toGx, toGy, at, mapId }) {
  ...
  return [
    ...(existing || []).slice(-6),
    {
      ...
      ox: fromGx + nx * 0.3,
      oy: fromGy + ny * 0.3,
      // End: exactly attackRange cells along the attack direction.
      ex: fromGx + nx * cfg.range,
      ey: fromGy + ny * cfg.range,
    },
  ]
}
