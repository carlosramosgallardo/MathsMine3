-- ============================================================
-- TEST: Enable bots with default drills for the next tick
-- How it works:
--   drillsTotal = DAILY_MINE_BASE(100) + COUNT(sell_transactions)
--   drillsLeft  = drillsTotal - COUNT(games today)
--   Target: drillsLeft = 100  -> totalExecs must be 0
--
-- This removes bot-only dummy sell_transactions created by drill tests.
-- ============================================================
...
-- 3. Remove bot sell_transactions so drillsTotal returns to DAILY_MINE_BASE(100)
